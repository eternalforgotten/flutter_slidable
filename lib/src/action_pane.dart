...
class ActionPane extends StatefulWidget {
  ...
  /// The left spacing between the tile and pane.
  final double left;

  /// The right spacing between the tile and pane.
  final double right;

  /// The top spacing between the tile and pane.
  final double top;

  /// The bottom spacing between the tile and pane.
  final double bottom;
